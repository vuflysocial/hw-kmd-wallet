...
test('Altcoin P2PKH addresses with a different pubkey hash prefix returns valid ouput script', () => {
	const bitcoinOutputScipt = buildOutputScript([{
		address: '1LukeQU5jwebXbMLDVydeH4vFSobRV9rkj',
		value: 100000000,
	}]);
	const litecoinOutputScipt = buildOutputScript([{
		address: 'Lf8hucmupbtenQ3VPdxvvJ8gTfAsaon2gf',
		value: 100000000,
	}]);
	const expectedOutputScript = '0100e1f505000000001976a914da6473ed373e08f46dd8003fca7ba72fbe9c555e88ac';
