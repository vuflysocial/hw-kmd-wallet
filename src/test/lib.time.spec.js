...
test('it should return 23 Feb 2018 03:00 (time - secondsToString)', () => {
  expect(secondsToString(timeExample / 1000)).toBe('23 Feb 2018 03:00');
});

test('it should return 23 Feb 2018 03:00:0 (time - secondsToString)', () => {
  expect(secondsToString(timeExample / 1000, false, true)).toBe('23 Feb 2018 03:00:0');
});
